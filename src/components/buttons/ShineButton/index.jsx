...
export const ShineButton = ({ children, className = "", isExpanded, icon: Icon, onClick }) => {
  ...
  return (
    ...
    >
      ...
      {!shouldReduce && (
        <span className="pointer-events-none absolute inset-0 overflow-hidden rounded-button">
          <motion.span
