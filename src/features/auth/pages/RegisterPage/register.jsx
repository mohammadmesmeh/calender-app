        ...
        <input
          ...
          className={`w-full rounded-input border bg-surface py-2.5 pl-10 ${
            ...
            error
              ...
              : 'border-border hover:border-border focus:border-indigo-400 focus:ring-indigo-100'
          }`}
        />
        {rightSlot && (
  ...
  return (
    <div className="relative flex min-h-screen w-full overflow-hidden bg-background">
      ...
      <div className="relative z-10 hidden w-1/2 flex-col justify-between p-12 lg:flex">
        ...
        >
          <div className="flex h-9 w-9 items-center justify-center rounded-icon bg-gradient-to-br from-indigo-500 to-violet-600 shadow-card shadow-indigo-900/40">
      ...
      <div className="relative z-10 flex w-full items-center justify-center px-4 py-10 sm:px-6 lg:w-1/2 lg:px-12">
        ...
        >
          <div className="rounded-card border border-white/10 bg-white/[0.07] p-8 shadow-card shadow-black/40 backdrop-blur-xl sm:p-10">
            {/* Mobile-only brand mark */}
            <div className="mb-6 flex items-center gap-2.5 lg:hidden">
              <div className="flex h-8 w-8 items-center justify-center rounded-icon bg-gradient-to-br from-indigo-500 to-violet-600">
            ...
            <AnimatePresence mode="wait">
              {successMessage && (
                <motion.div
                  ...
                  className="mt-6 flex items-start gap-2.5 overflow-hidden rounded-card border border-emerald-400/20 bg-emerald-400/10 p-3.5"
                >
              ...
              {firebaseError && (
                <motion.div
                  ...
                  animate={{ opacity: 1, height: 'auto' }}
                  exit={{ opacity: 0, height: 0 }}
                  className="mt-6 flex items-start gap-2.5 overflow-hidden rounded-card border border-red-400/20 bg-red-400/10 p-3.5"
                >
            ...
            <div className="mt-7 rounded-card bg-surface p-5 shadow-card shadow-black/20 sm:p-6">
              <form onSubmit={handleSubmit(onSubmitEmail)} className="space-y-4">
                ...
                <motion.button
                  ...
                  className={`group relative flex w-full items-center justify-center gap-2 overflow-hidden rounded-button px-4 py-2.5 text-[15px] font-semibold text-white shadow-card transition-all duration-200 ${
                    isLoading || isLoadingGoogle
                      ? 'cursor-not-allowed bg-border shadow-none'
                ...
                <motion.button
                  ...
                  className={`flex w-full items-center justify-center gap-2.5 rounded-button border px-4 py-2.5 text-[15px] font-semibold transition-all duration-200 ${
                    isLoading || isLoadingGoogle
                      ? 'cursor-not-allowed border-border bg-background text-text-muted'
                      : 'border-border bg-surface text-text hover:border-border hover:bg-background hover:shadow-card active:scale-[0.98]'
                  }`}
                >
                  {isLoadingGoogle ? (
                    <>
          ...
          <p className="mt-6 text-center text-xs leading-relaxed text-text-secondary">
            ...
            <span className="cursor-pointer text-text-muted underline-offset-2 hover:underline">
              Terms of Service
            </span>{' '}
            and{' '}
            <span className="cursor-pointer text-text-muted underline-offset-2 hover:underline">
