...
export const DashboardHeader = () => {
    return (
        <div className="dashboard-header-container flex items-center justify-between  shadow-xl px-3 md:px-6 py-2 md:py-4 ">
            ...
            <div className="dashboard-header-actions flex items-center justify-end  w-full gap-2 md:gap-4">
                <form action="" className="relative ">
                    ...
                    <input type="search" id="search" name='search' placeholder="Search tasks, events..." className="bg-white w-32 md:w-60 text-text border-2 border-border rounded-xl py-2 px-8 placeholder:text-text-muted focus:outline-none focus:border-primary transition-colors focus:ring-2 focus:ring-primary/30 " />
                </form>
